...
pub const HOME_POSITION: [(usize, f32); 20] = [
    ...
    (23, 0.0),
    (24, (90.0 as f32).to_radians()),
    (25, 0.0),
    (11, 0.0),
    (12, (10.0 as f32).to_radians()),
    (13, 0.0),
    (14, (-90.0 as f32).to_radians()),
    (15, 0.0),
    (41, (-20.0 as f32).to_radians()),
    (42, (0.0 as f32).to_radians()),
    (43, 0.0),
    (44, (-50.0 as f32).to_radians()),
    (45, (30.0 as f32).to_radians()),
    (31, (20.0 as f32).to_radians()),
    (32, (0.0 as f32).to_radians()),
    (33, 0.0),
    (34, (50.0 as f32).to_radians()),
    (35, (-30.0 as f32).to_radians()),
];

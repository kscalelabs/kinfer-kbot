...
pub const HOME_POSITION: [(usize, f32); 20] = [
    ...
    (23, 0.0),
    (24, 15.0_f32.to_radians()),
    (25, 0.0),
    (11, 0.0),
    (12, 10.0_f32.to_radians()),
    (13, 0.0),
    (14, (-15.0_f32).to_radians()),
    (15, 0.0),
    (41, (-25.0_f32).to_radians()),
    (42, (-5.0_f32).to_radians()),
    (43, 0.0),
    (44, (-50.0_f32).to_radians()),
    (45, 25.0_f32.to_radians()),
    (31, 25.0_f32.to_radians()),
    (32, 5.0_f32.to_radians()),
    (33, 0.0),
    (34, 50.0_f32.to_radians()),
    (35, (-25.0_f32).to_radians()),
];
